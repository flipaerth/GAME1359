/*
Using the videos above as a reference, you are to use Unity/C# to build a simple 3D platformer
for this week's assignment; however, unlike in the video, also ensure that:
...
Next week, we'll add stuff to improve on this :)
 */